...
execute @a[tag=back,scores={posx_0=63..127,posx_0=!63}] ~~~tag @s add tp_0
execute @a[tag=back,tag=tp_0] ~~~tp~63~~
execute @a[tag=back,tag=tp_0] ~~~tp~1~~
execute @a[tag=back,tag=tp_0] ~~~scoreboard players remove @s posx_0 63
execute @a[tag=back,tag=tp_0] ~~~scoreboard players remove @s posx_0 1
tag @a[tag=back,tag=tp_0] remove tp_0
execute @a[tag=back,scores={posx_0=63..127}] ~~~scoreboard players remove @s posx_0 64
...
execute @a[tag=back,scores={posz_0=63..127,posz_0=!63}] ~~~tag @s add tp_0
execute @a[tag=back,tag=tp_0] ~~~tp~~~63
execute @a[tag=back,tag=tp_0] ~~~tp~~~1
execute @a[tag=back,tag=tp_0] ~~~scoreboard players remove @s posz_0 63
execute @a[tag=back,tag=tp_0] ~~~scoreboard players remove @s posz_0 1
tag @a[tag=back,tag=tp_0] remove tp_0
...
execute @a[tag=back,scores={posy_0=63..127,posy_0=!63}] ~~~tag @s add tp_0
execute @a[tag=back,tag=tp_0] ~~~tp~~63~
execute @a[tag=back,tag=tp_0] ~~~tp~~1~
execute @a[tag=back,tag=tp_0] ~~~scoreboard players remove @s posy_0 63
execute @a[tag=back,tag=tp_0] ~~~scoreboard players remove @s posy_0 1
tag @a[tag=back,tag=tp_0] remove tp_0
