...
x = GetInputAndTestIfisIntOrFolat('请输入另一点B关于实体A的相对坐标的X轴坐标')
# 设定另一点B关于实体A的相对坐标的X轴坐标

y = GetInputAndTestIfisIntOrFolat('请输入另一点B关于实体A的相对坐标的Y轴坐标')
# 设定另一点B关于实体A的相对坐标的Y轴坐标

z = GetInputAndTestIfisIntOrFolat('请输入另一点B关于实体A的相对坐标的Z轴坐标')
# 设定另一点B关于实体A的相对坐标的Z轴坐标
...
B = -x*math.sin(rx)*math.sin(ry)+y*math.cos(rx)+z*math.sin(rx)*math.cos(ry)
C = -x*math.cos(rx)*math.sin(ry)-y*math.sin(rx)+z*math.cos(rx)*math.cos(ry)
# 计算目标值
