<<<<<<< HEAD
execute @a[tag=uw:getpos,tag=uw:getpos_allow_distance_1,tag=uw:getpos_allow] ~ ~ ~ summon minecraft:armor_stand uw:getpos_mark_for_master
execute @a[tag=uw:getpos,tag=uw:getpos_allow_distance_1,tag=uw:getpos_allow] ~ ~ ~ tag @e[type=minecraft:armor_stand,name=uw:getpos_mark_for_master,r=0.1,c=1] add uw:getpos_mfm
...
execute @e[tag=uw:getpos_mfm] ~ ~ ~ execute @e[tag=uw:getpos_helper,y=-30000000,z=-300000000,dy=60000000,dz=60000000,dx=-30000000] ~ ~ ~ tp ~7 ~ ~
#1
...
execute @e[tag=uw:getpos_mfm] ~ ~ ~ execute @e[tag=uw:getpos_helper,x=-30000000,z=-300000000,dx=60000000,dz=60000000,dy=-30000000] ~ ~ ~ tp ~ ~7 ~
#2
...
execute @e[tag=uw:getpos_mfm] ~ ~ ~ execute @e[tag=uw:getpos_helper,x=-30000000,y=-300000000,dx=60000000,dy=60000000,dz=-30000000] ~ ~ ~ tp ~ ~ ~7
#3
#be_sure_that_is_x-/y-/z-

execute @e[tag=uw:getpos_helper] ~ ~ ~ scoreboard players operation @s uw:posx = @a[tag=uw:getpos,tag=uw:getpos_allow_distance_1,tag=uw:getpos_allow] uw:posx
execute @e[tag=uw:getpos_helper] ~ ~ ~ scoreboard players operation @s uw:posy = @a[tag=uw:getpos,tag=uw:getpos_allow_distance_1,tag=uw:getpos_allow] uw:posy
execute @e[tag=uw:getpos_helper] ~ ~ ~ scoreboard players operation @s uw:posz = @a[tag=uw:getpos,tag=uw:getpos_allow_distance_1,tag=uw:getpos_allow] uw:posz
#score_reset
...
#9
execute @e[tag=uw:getpos_helper,tag=uw:getpos_xremove] ~ ~ ~ scoreboard players remove @s uw:posx 7
execute @e[tag=uw:getpos_helper,tag=uw:getpos_yremove] ~ ~ ~ scoreboard players remove @s uw:posy 7
execute @e[tag=uw:getpos_helper,tag=uw:getpos_zremove] ~ ~ ~ scoreboard players remove @s uw:posz 7
#10
#getpos

execute @a[tag=uw:getpos,tag=uw:getpos_allow_distance_1,tag=uw:getpos_allow] ~ ~ ~ scoreboard players operation @s uw:posx = @e[tag=uw:getpos_helper] uw:posx
execute @a[tag=uw:getpos,tag=uw:getpos_allow_distance_1,tag=uw:getpos_allow] ~ ~ ~ scoreboard players operation @s uw:posy = @e[tag=uw:getpos_helper] uw:posy
execute @a[tag=uw:getpos,tag=uw:getpos_allow_distance_1,tag=uw:getpos_allow] ~ ~ ~ scoreboard players operation @s uw:posz = @e[tag=uw:getpos_helper] uw:posz
#score_operation_=
