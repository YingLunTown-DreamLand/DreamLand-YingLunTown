...
//7
execute @e[name=posy] ~~~execute @e[tag=posy,r=128,rm=64] ~~~execute @e[name=posy] ~~~execute @e[tag=posy,r=127.999999,rm=63.999999] ~~~scoreboard players add @e[name=posy] posy 64
execute @e[name=posy] ~~~execute @e[tag=posy,r=128,rm=64] ~~~execute @e[name=posy] ~~~execute @e[tag=posy,r=127.999999,rm=63.999999] ~~~execute @e[name=posy] ~~~tp~~64~
//8
execute @e[name=posy] ~~~execute @e[tag=posy,r=64,rm=32] ~~~execute @e[name=posy] ~~~execute @e[tag=posy,r=63.999999,rm=31.999999] ~~~scoreboard players add @e[name=posy] posy 32
execute @e[name=posy] ~~~execute @e[tag=posy,r=64,rm=32] ~~~execute @e[name=posy] ~~~execute @e[tag=posy,r=63.999999,rm=31.999999] ~~~execute @e[name=posy] ~~~tp~~32~
//9
