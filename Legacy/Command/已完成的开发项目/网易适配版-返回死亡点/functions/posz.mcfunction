...
//17
execute @e[name=posz] ~~~execute @e[z=~1,tag=posz,r=127,rm=63] ~~~execute @e[name=posz] ~~~execute @e[tag=posz,r=127.999999,rm=63.999999] ~~~tag @e[name=posz] add sp
execute @e[tag=sp] ~~~scoreboard players add @s posz 63
execute @e[tag=sp] ~~~scoreboard players add @s posz 1
execute @e[tag=sp] ~~~tp~~~63
execute @e[tag=sp] ~~~tp~~~1
//18
execute @e[name=posz] ~~~execute @e[z=~1,tag=posz,r=63,rm=31] ~~~execute @e[name=posz] ~~~execute @e[tag=posz,r=63.999999,rm=31.999999] ~~~scoreboard players add @e[name=posz] posz 32
execute @e[name=posz] ~~~execute @e[z=~1,tag=posz,r=63,rm=31] ~~~execute @e[name=posz] ~~~execute @e[tag=posz,r=63.999999,rm=31.999999] ~~~execute @e[name=posz] ~~~tp~~~32
//19
