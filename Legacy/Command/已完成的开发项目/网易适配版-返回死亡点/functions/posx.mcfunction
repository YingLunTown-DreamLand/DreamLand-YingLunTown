...
//17
execute @e[name=posx] ~~~execute @e[x=~1,tag=posx,r=127,rm=63] ~~~execute @e[name=posx] ~~~execute @e[tag=posx,r=127.999999,rm=63.999999] ~~~tag @e[name=posx] add sp
execute @e[tag=sp] ~~~scoreboard players add @s posx 63
execute @e[tag=sp] ~~~scoreboard players add @s posx 1
execute @e[tag=sp] ~~~tp~63~~
execute @e[tag=sp] ~~~tp~1~~
//18
execute @e[name=posx] ~~~execute @e[x=~1,tag=posx,r=63,rm=31] ~~~execute @e[name=posx] ~~~execute @e[tag=posx,r=63.999999,rm=31.999999] ~~~scoreboard players add @e[name=posx] posx 32
execute @e[name=posx] ~~~execute @e[x=~1,tag=posx,r=63,rm=31] ~~~execute @e[name=posx] ~~~execute @e[tag=posx,r=63.999999,rm=31.999999] ~~~execute @e[name=posx] ~~~tp~32~~
//19
